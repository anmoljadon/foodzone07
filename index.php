...
<head>
   ...
   <title>FoodZone | Online Food Ordering</title>
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><i class="fas fa-utensils"></i>FoodZone</a>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>table no : (optional) /only if you are sitting in restaurant</span>
            <input type="number" name="table_no" class="box" required placeholder="e.g. 1" min="0" max="999999" onkeypress="if(this.value.length == 1) return false;">
         </div>
      </div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>We understand that food is very important in one's life so its our responsibility to provide you the best food and enjoy the life.</p>
      ...
      <div class="box">
         ...
         <p>We try to improve our services day by day and try to provide to the better experience. That'why we try to deliver the food in 30 mins.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>share is caring! you should share the food with your friends so that they are feels the best experience of their life and they also share with others.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <div class="swiper-container review-slider">
       ...
       <div class="swiper-wrapper">
           ...
           <div class="swiper-slide slide">
               ...
               <p>Good Food Quality and service also.</p>
           </div>
           ...
           <div class="swiper-slide slide">
               ...
               <p>Very fast delivery and food quality is also very good.</p>
           </div>
           ...
           <div class="swiper-slide slide">
               ...
               <p>delivers the food in just 10 mins, i've love it.</p>
           </div>
           ...
           <div class="swiper-slide slide">
               ...
               <p>the way they packed the food is very good, packaging never get damaged.</p>
           </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Opens in all days of week</p>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>email address</h3>
         <p>foodzone05@gmail.com</p>
         <p>enjoyfood@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>FoodZone</span> | all rights reserved!
   </div>
